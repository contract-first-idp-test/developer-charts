...
All charts in this repository release use version `1.0.2`. Installations select an exact compatible
tag (the current workshop remains deliberately pinned to `v1.0.1`). Repository compatibility is declared in
